...
public static class GsiTestBriefingUi
{
    ...
    public static Refs Ensure(Transform parent, UnityAction onStartClicked)
    {
        ...
        bg.color = GsiUiAppearance.ShopScreenBackground;
        ...
        titleRt.offsetMax = new Vector2(-40f, -32f);
        ...
        bodyRt.offsetMax = new Vector2(-48f, 0f);
        var bodyTmp = bodyGo.AddComponent<TextMeshProUGUI>();
        bodyTmp.fontSize = 22;
        bodyTmp.alignment = TextAlignmentOptions.TopJustified;
