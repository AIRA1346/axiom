...
/// <summary>
/// IntroScene을 자동 생성합니다. Tools > ARCHE > Setup
/// 무채색 UI, IntroController 포함.
/// </summary>
public static class IntroSceneCreator
{
    private const string ScenePath = "Assets/Scenes/IntroScene.unity";

    [MenuItem("Tools/ARCHE/Setup/Create Intro Scene")]
    [MenuItem("Assets/ARCHE/Create Intro Scene")]
    ...
    private static void CreateIntroController(GameObject canvasObj)
    {
        ...
        so.FindProperty("_mainSceneName").stringValue = "LobbyScene";
