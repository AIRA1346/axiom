...
/// </summary>
public sealed class CpsTestController : MonoBehaviour, IMiniGameController
{
    public string GameId => "ClicksPerSecond";
    ...
    private void OnEnable()
    {
        ...
        if (GameManager.Instance != null)
        {
            ...
            {
                _assignedGrade = GameManager.Instance.GetPracticeGrade(TestMode.ClicksPerSecond);
            }
    ...
    private IEnumerator RunSessionRoutine()
    {
        ...
        if (isUnified && GameManager.Instance != null)
        {
            ...
            OnGameFinished?.Invoke(averageCps, true);
            _sessionRoutine = null;
            yield break;
        }

        int cpsRank = _assignedGrade;
        ...
        OnGameFinished?.Invoke(averageCps, !failed);
