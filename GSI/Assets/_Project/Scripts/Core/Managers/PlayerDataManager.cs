...
/// This manager only loads and saves long-term records through GsiSaveSystem.
/// </summary>
public sealed class PlayerDataManager : MonoBehaviour
{
    ...
    /// <summary>After Steam Cloud merge or external save writes, refresh cached fields.</summary>
    ...
    public bool CheckAndSaveBestReactionTime(float newTime)
    {
        ...
        GsiSaveSystem.SetFloat(BestReactionTimeKey, BestReactionTime);
        GsiSaveSystem.Save();
    ...
    public bool CheckAndSaveBestAimTime(float newTime)
    {
        ...
        BestAimTime = newTime;
        GsiSaveSystem.SetFloat(BestAimTimeKey, BestAimTime);
        GsiSaveSystem.Save();
        NotifyPlayerDataChanged();
        return true;
    }
    ...
    public bool CheckAndSaveBestMemorySpan(float newSpan)
    {
        ...
        GsiSaveSystem.SetFloat(BestMemorySpanKey, BestMemorySpan);
        GsiSaveSystem.Save();
        NotifyPlayerDataChanged();
        return true;
    }
    ...
    {
        GsiSaveSystem.SetFloat(BestRhythmAccuracyKey, BestRhythmAccuracy);
        GsiSaveSystem.SetFloat(BestRhythmMeanErrorKey, BestRhythmMeanError);
        GsiSaveSystem.Save();
        NotifyPlayerDataChanged();
    }
    ...
    public bool CheckAndSaveBestMotAccuracy(float accuracyPercent)
    {
        if (BestMotAccuracy < 0f)
        {
            ...
            GsiSaveSystem.SetFloat(BestMotAccuracyKey, BestMotAccuracy);
            GsiSaveSystem.Save();
            NotifyPlayerDataChanged();
            return true;
        }
    ...
    public bool CheckAndSaveBestBulletHellTime(float survivalSecondsSum)
    {
        if (BestBulletHellTime < 0f)
        {
            ...
            GsiSaveSystem.SetFloat(BestBulletHellTimeKey, BestBulletHellTime);
            GsiSaveSystem.Save();
            NotifyPlayerDataChanged();
            return true;
        }
    ...
    public bool CheckAndSaveBestCps(float averageCps)
    {
        ...
        {
            BestCps = averageCps;
            GsiSaveSystem.SetFloat(BestCpsKey, BestCps);
            GsiSaveSystem.Save();
            NotifyPlayerDataChanged();
            return true;
        }
    ...
    {
        BestReactionTime = GsiSaveSystem.GetFloat(BestReactionTimeKey, DefaultBestReactionTime);
        BestAimTime = GsiSaveSystem.GetFloat(BestAimTimeKey, DefaultBestReactionTime);
        BestMemorySpan = GsiSaveSystem.GetFloat(BestMemorySpanKey, NoMemoryRecord);
        BestRhythmAccuracy = GsiSaveSystem.GetFloat(BestRhythmAccuracyKey, -1f);
        BestRhythmMeanError = GsiSaveSystem.GetFloat(BestRhythmMeanErrorKey, 999f);
        BestMotAccuracy = GsiSaveSystem.GetFloat(BestMotAccuracyKey, -1f);
        BestBulletHellTime = GsiSaveSystem.GetFloat(BestBulletHellTimeKey, -1f);
        BestCps = GsiSaveSystem.GetFloat(BestCpsKey, -1f);
        BestUnifiedExamTotal = GsiSaveSystem.GetFloat(BestUnifiedExamTotalKey, -1f);
    }
    ...
    public bool CheckAndSaveBestUnifiedExamTotal(float totalScore)
    {
        if (BestUnifiedExamTotal < 0f || totalScore > BestUnifiedExamTotal + 0.01f)
        {
            ...
            GsiSaveSystem.SetFloat(BestUnifiedExamTotalKey, BestUnifiedExamTotal);
            GsiSaveSystem.Save();
            NotifyPlayerDataChanged();
            return true;
        }
    ...
    {
        string prev = GsiSaveSystem.GetString(UnifiedExamHistoryKey, string.Empty);
        ...
        GsiSaveSystem.SetString(UnifiedExamHistoryKey, merged);
        GsiSaveSystem.Save();
        NotifyPlayerDataChanged();
    }
        ...
        string completedAtTimestamp)
    {
        ...
        GsiSaveSystem.SetString(UnifiedExamHistoryJsonKey, JsonUtility.ToJson(env));
        GsiSaveSystem.Save();
        NotifyPlayerDataChanged();
    }
    ...
    {
        string json = GsiSaveSystem.GetString(UnifiedExamHistoryJsonKey, string.Empty);
