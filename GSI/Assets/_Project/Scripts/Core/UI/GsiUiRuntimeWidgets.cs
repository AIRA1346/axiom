...
public static class GsiUiRuntimeWidgets
{
    ...
    /// <summary>Arcane row cards use a thin brass rim and a heavy candlelit shadow.</summary>
    public static void ApplyRowCardShadow(Graphic rowBackground)
    {
        if (rowBackground is not Image img)
        {
            return;
        }

        GsiArcaneUi.ApplyRow(img);
    }

    /// <summary>Apply the shared arcane rim to interactive controls.</summary>
    ...
    public static void ApplySecondaryHeaderButtonLook(Button btn)
    {
        ...
        {
            g.color = GsiUiAppearance.SecondaryButton;
        }
    ...
    public static void ApplyAccentTintedActionButton(Button btn)
    {
        ...
        if (btn.targetGraphic is Graphic g)
        {
            g.color = GsiUiAppearance.PrimaryActionButton;
        }
        GsiArcaneUi.ApplyButton(btn, primary: true);
    }
}
