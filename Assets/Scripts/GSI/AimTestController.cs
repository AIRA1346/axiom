    ...
    private void StartAimTest()
    {
        ...
        if (GameManager.Instance != null && GameManager.Instance.CurrentTestType == TestType.Practice)
        {
            PracticeDifficulty.GetAimPracticeParams(
                GameManager.Instance.GetPracticeGrade(TestMode.AimPrecision),
                out _targetsRequired,
                out _missPenaltySeconds,
                out _moveRangeX,
                out _moveRangeY);
        }
        else if (GameManager.Instance != null && GameManager.Instance.CurrentTestType == TestType.UnifiedOfficialExam)
        {
            PracticeDifficulty.GetAimPracticeParams(
        ...
        else if (GameManager.Instance != null && GameManager.Instance.CurrentTestType == TestType.OfficialExam)
        {
            PracticeDifficulty.GetAimPracticeParams(
                GameManager.Instance.GetPracticeGrade(TestMode.AimPrecision),
                out _targetsRequired,
        ...
        if (GameManager.Instance != null)
        {
            ...
            {
                aimGrade = GameManager.Instance.GetPracticeGrade(TestMode.AimPrecision);
            }
            else if (GameManager.Instance.CurrentTestType == TestType.UnifiedOfficialExam)
            {
                aimGrade = GameManager.Instance.UnifiedExamGrade;
            }
        ...
        AimDifficulty.ApplyTargetSize(_aimTargetRect, aimGrade);
